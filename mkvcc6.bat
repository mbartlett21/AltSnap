...
link altsnap.obj altsnap.res /nodefaultlib /filealign:512 /subsystem:windows /OPT:REF /OPT:ICF,7 /LARGEADDRESSAWARE  /machine:I386  /entry:ntclWinMain kernel32.lib user32.lib shell32.lib advapi32.lib gdi32.lib comctl32.lib
